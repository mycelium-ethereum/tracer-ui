...
import { NavPopout, NavPopoutOption, NavPopoutContainer } from "../../atoms/NavPopout";
...
const NavSettings: React.FC<NavSettingsProps> = ({ navMenuOpen, setNavMenuOpen, showSettingsPopout, setShowSettingsPopout, children }) => {
    ...
    return (
        <NavPopoutContainer ref={settingsContainerRef}>
            <NavButton onClick={handleClick} selected={showSettingsPopout} navMenuOpen={navMenuOpen}>
                <SettingsSVG />
            </NavButton>
